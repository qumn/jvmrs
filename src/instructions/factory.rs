...
pub(crate) fn new_instruction(opcode: u8) -> Box<dyn Instruction> {
    match opcode {
        ...
        0x12 => Box::new(LDC::default()),
        0x13 => Box::new(LDC_W::default()),
        0x14 => Box::new(LDC2_W::default()),
        ...
        0xb2 => Box::new(GET_STATIC::default()),
        0xb3 => Box::new(PUT_STATIC::default()),
        0xb4 => Box::new(GET_FEILD::default()),
        0xb5 => Box::new(PUT_FIELD::default()),
        0xb6 => Box::new(INVOKE_VIRTUAL::default()),
        0xb7 => Box::new(INVOKE_SPECIAL::default()),
        //  0xb8 => Box::new(return),
        //  0xb9 => Box::new(return),
        //  0xba => Box::new(return),
         0xbb => Box::new(NEW::default()),
        //  0xbc => Box::new(return),
        //  0xbd => Box::new(return),
        //  0xbe => Box::new(return),
        //  0xbf => Box::new(return),
